...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-navbar aheto-navbar--karma_business' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('karma_business-navbar-modern', $shortcode_dir . 'assets/css/karma_business_layout1.css', null, null);
}
						...
						<div class="aheto-navbar--item">
							...
							<?php endif;
                                ...
                                if ( $link['type_link'] == 'socials' ) {
                                    ...
                                    echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s" target="_blank" rel="noreferrer noopener"><i class="ion-social-%2$s"></i></a>', 'left_links_', $link );
						...
						<div class="aheto-navbar--item">
							...
							<?php endif;
                                ...
                                if ( $link['type_link'] == 'socials' ) {
                                    ...
                                    echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s"><i class="ion-social-%2$s"></i></a>', 'right_links_', $link );
