...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-navbar--funero-simple' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('funero-navbar-layout1', $shortcode_dir . 'assets/css/funero_layout1.css', null, null);
}
?>
					...
					<?php foreach ( $left_links as $index => $link ) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ( $link['type_link'] == 'socials' ) {
								if(!empty($funero_soc_label)){
									echo '<span class="aheto-navbar--item-soc-label">'.esc_html($funero_soc_label).'</span>';
								}
								...
								echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s" target="_blank" rel="noreferrer noopener"><i class="' . $font_icon . '%2$s"></i></a>', 'left_links_', $link );
					...
					<?php foreach ( $right_links as $index => $link ) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ( $link['type_link'] == 'socials' ) {
								...
								echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s" target="_blank" rel="noreferrer noopener"><i class="' . $font_icon . '%2$s"></i></a>', 'right_links_', $link );
