...
//Divider border
$aira_bot_border = $aira_bot_border ? 'aheto-navbar__bot_border' : '';
...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-navbar aheto-navbar--aira-modern' );
$this->add_render_attribute( 'wrapper', 'class', $columns . '-columns' );
$this->add_render_attribute( 'wrapper', 'class', [$remove_borders, $aira_bot_border] );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-navbar-modern', $sc_dir . 'assets/css/aira_layout1.css', null, null);
}
?>
