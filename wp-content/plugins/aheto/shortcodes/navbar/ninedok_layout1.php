...
$this -> add_render_attribute ( 'wrapper', 'class', 'aheto-navbar--ninedok-modern' );
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style ( 'ninedok-navbar-layout1', $shortcode_dir . 'assets/css/ninedok_layout1.css', null, null );
} ?>
