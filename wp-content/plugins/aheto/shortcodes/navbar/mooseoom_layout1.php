...
$this->add_render_attribute('wrapper', 'class', 'aheto-navbar--mooseoom');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('mooseoom-navbar-layout1', $shortcode_dir . 'assets/css/mooseoom_layout1.css', null, null);
} ?>
