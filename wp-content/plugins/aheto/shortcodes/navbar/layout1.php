...
$this->add_render_attribute('wrapper', 'class', 'aheto-navbar aheto-navbar--modern');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('navbar-style-1', $sc_dir . 'assets/css/layout1.css', null, null);
}
					...
					<?php foreach ($left_links as $index => $link) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ($link['type_link'] == 'socials') {
								...
								echo Helper::get_social_networks_list('<a class="aheto-navbar--item-link icon" target="_blank"  href="%1$s"><i class="' . $font_icon . '%2$s"></i></a>', 'left_links_', $link);
					...
					<?php foreach ($right_links as $index => $link) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ($link['type_link'] == 'socials') {
								...
								echo Helper::get_social_networks_list('<a class="aheto-navbar--item-link icon" target="_blank"  href="%1$s"><i class="' . $font_icon . '%2$s"></i></a>', 'right_links_', $link);
