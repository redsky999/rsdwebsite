...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-navbar aheto-navbar--aira-footer' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-navbar-footer', $sc_dir . 'assets/css/aira_layout2.css', null, null);
}
?>
