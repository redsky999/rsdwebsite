...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style( 'outsourceo-title-bar-layout1', $shortcode_dir . 'assets/css/outsourceo_layout1.css', null, null );
}
?>
    ...
    <div class="aheto-titlebar__main">
        <div class="aheto-titlebar__content">
            <div class="aheto-titlebar__content-inner">
				...
				if ( ! empty( $title ) ) {
					echo '<' . $title_tag . ' class="aheto-titlebar__title">' . wp_kses( $title, 'post' ) . '</' . $title_tag . '>';
				} ?>
