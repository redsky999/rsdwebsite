...
// Block Wrapper.
$this->add_render_attribute('block_wrapper', 'class', 'aheto-features--rela-modern');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('rela-features-single-layout3', $shortcode_dir . 'assets/css/rela_layout3.css', null, null);
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
    ...
    <div <?php $this->render_attribute_string('block_wrapper'); ?>>
        <a class="aheto-features-block__wrap" href="<?php echo esc_attr($rela_link_url); ?>">
            <?php if ($s_image) : ?>
            ...
            <div class="aheto-features-block__info">
                <?php if (!empty($s_heading)) : ?>
                    ...
                    <h3 class="aheto-features-block__title"><?php echo wp_kses($highlight_heading, 'post'); ?></h3>
                <?php endif; ?>
