...
$this->add_render_attribute('wrapper', 'class', 'aheto-features--sterling-4');

$sterling_use_main = isset($sterling_use_main) && $sterling_use_main ? 'scale' : '';
$this->add_render_attribute('wrapper', 'class', $sterling_use_main);
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-features-single-scale', $sc_dir . 'assets/css/sterling_layout4.css', null, null);
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	...
	<?php endif; ?>
	<div class="aheto-features__content">
