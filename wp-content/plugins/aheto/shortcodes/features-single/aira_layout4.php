...
// Block Wrapper.
$this->add_render_attribute('block_wrapper', 'class', 'aheto-features--aira-minimal');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-features-single-minimal', $sc_dir . 'assets/css/aira_layout4.css', null, null);
}
?>
