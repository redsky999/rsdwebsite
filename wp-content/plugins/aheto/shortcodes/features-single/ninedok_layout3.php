...
// Block Wrapper.
$this -> add_render_attribute ( 'block_wrapper', 'class', 'aheto-content--ninedok-classic' );
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style ( 'ninedok-features-single-layout3', $shortcode_dir . 'assets/css/ninedok_layout3.css', null, null );
} ?>
<div <?php $this -> render_attribute_string ( 'wrapper' ); ?>>

    <div <?php $this -> render_attribute_string ( 'block_wrapper' ); ?>>
        <div class="aheto-content-block__wrap <?php echo esc_attr ( $ninedok_align ); ?>">
			...
			<?php if ( !empty( $ninedok_add_button )) : ?>
