...
// Block Wrapper.
$this->add_render_attribute('block_wrapper', 'class', 'aheto-features--acacio-simple-scaled');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('acacio-features-single-layout3', $shortcode_dir . 'assets/css/acacio_layout3.css', null, null);
}
		...
		<div class="aheto-features-block__wrap">
            ...
            <div class="aheto-features-block__content">
                ...
                <?php if ( isset($acacio_subtitle) && !empty($acacio_subtitle)) : ?>
                    <h5 class="aheto-content-block__subtitle"><?php echo esc_html($acacio_subtitle); ?></h5>
                <?php endif; ?>
