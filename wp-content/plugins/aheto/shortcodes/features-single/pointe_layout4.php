...
// Block Wrapper.
$this->add_render_attribute('block_wrapper', 'class', 'aheto-features--pointe-img-modern');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-features-single-img_2', $sc_dir . 'assets/css/pointe_layout4.css', null, null);
}
?>
    ...
    <div <?php $this->render_attribute_string('block_wrapper'); ?>>
        ...
        foreach ($items as $item) : ?>
            ...
            <a href="<?php echo esc_url($button['href']); ?>" target="<?php echo esc_attr($target); ?>" <?php echo esc_attr($rel); ?>>
                <?php if (!empty($item['pointe_add_image'])) : ?>
                    <div class="aheto-features--holder">
                        <?php echo Helper::get_attachment($item['pointe_add_image'], ['class' => 'aheto-features--img', 'class' => 'js-bg'], $image_size); ?>
                    </div>
                <?php endif; ?>
