...
// Block Wrapper.
$this->add_render_attribute('block_wrapper', 'class', 'aheto-features--aira-modern');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-features-single-modern', $sc_dir . 'assets/css/aira_layout1.css', null, null);
}
?>
<div <?php $this->render_attribute_string('wrapper'); ?>>
    ...
    <div <?php $this->render_attribute_string('block_wrapper'); ?>>
        <?php
        $background_image = \Aheto\Helper::get_background_attachment($s_image, $aira_image_size, $atts, 'aira_');
        ?>
