...
$this->add_render_attribute('wrapper', 'class', 'aheto-features--sterling-2');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-features-single-img-2', $sc_dir . 'assets/css/sterling_layout2.css', null, null);
}
