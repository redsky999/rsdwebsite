...
add_action('aheto_before_aheto_features-single_register', 'funero_features_single_layout4');

/**
 * Features Banner Slider
 */

function funero_features_single_layout4($shortcode) {
	$preview_dir = '//assets.aheto.co/features-single/previews/';
	$shortcode->add_layout('funero_layout4', [
		'title' => esc_html__('Features Single 18', 'funero'),
		'image' => $preview_dir . 'funero_layout4.jpg',
	]);

	aheto_demos_add_dependency(['use_heading', 't_heading'], ['funero_layout4'], $shortcode);
	$shortcode->add_dependecy('funero_subtitle', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_title', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_image_bg', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_image', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_desc', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_subtitle_use_typo', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_subtitle_typo', 'template', 'funero_layout4');
	$shortcode->add_dependecy('funero_subtitle_typo', 'funero_subtitle_use_typo', 'true');
	$shortcode->add_dependecy('funero_desc_use_typo', 'template', [ 'funero_layout4']);
	$shortcode->add_dependecy('funero_desc_typo', 'template', 'funero_layout4');
	$shortcode->add_dependecy('funero_desc_typo', 'funero_desc_use_typo', 'true');
	$shortcode->add_dependecy('funero_link_title', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_link_url', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_link_use_typo', 'template', ['funero_layout4']);
	$shortcode->add_dependecy('funero_link_typo', 'template', 'funero_layout4');
...
function funero_features_single_layout4_dynamic_css($css, $shortcode) {
...
add_filter('aheto_features_single_dynamic_css', 'funero_features_single_layout4_dynamic_css', 10, 2);
