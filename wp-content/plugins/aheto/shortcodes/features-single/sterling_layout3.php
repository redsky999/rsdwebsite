...
$this->add_render_attribute('wrapper', 'class', 'aheto-features--sterling-3');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-features-single-bg', $sc_dir . 'assets/css/sterling_layout3.css', null, null);
}
