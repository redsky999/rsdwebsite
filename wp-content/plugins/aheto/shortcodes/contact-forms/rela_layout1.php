...
$this->add_render_attribute('wrapper', 'class', 'widget_aheto__cf--rela__subscribe-simple');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('rela-contact-forms-layout1', $shortcode_dir . 'assets/css/rela_layout1.css', null, null);
}
?>
