...
$azyn_disable_creative_btn = isset($azyn_disable_creative_btn) && $azyn_disable_creative_btn ? 'disable-creative-btn' : '';

// Wrapper.
$this->add_render_attribute( 'wrapper', 'id', $element_id );
$this->add_render_attribute( 'wrapper', 'class', 'aheto__cf--azyn-simple' );
$this->add_render_attribute( 'wrapper', 'class', $azyn_disable_creative_btn );
