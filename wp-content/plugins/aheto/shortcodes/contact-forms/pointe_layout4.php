...
$this->add_render_attribute( 'wrapper', 'class', 'widget_aheto__cf--pointe-classic-form' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-cf-classic-form', $sc_dir . 'assets/css/pointe_layout4.css', null, null);
}
if ( !Helper::is_Elementor_Live()) {
	wp_enqueue_script('pointe-cf-classic-form-js', $sc_dir . 'assets/js/pointe_layout4.min.js', array('jquery'), null);
} ?>
...
<div <?php $this->render_attribute_string( 'wrapper' ); ?>>
	...
	<?php if ( !empty( $title ) ) :
		...
		echo '<' .  $pointe_title_tag . ' class="widget_aheto__title">' . wp_kses_post( $title ). '</'.  $pointe_title_tag . '>';
