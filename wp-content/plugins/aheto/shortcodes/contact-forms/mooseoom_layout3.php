...
$this->add_render_attribute('wrapper', 'class', 'widget_aheto__cf--mooseoom__allfield');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('mooseoom-contact-forms-layout3', $shortcode_dir . 'assets/css/mooseoom_layout3.css', null, null);
} ?>
