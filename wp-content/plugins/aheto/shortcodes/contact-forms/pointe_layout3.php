...
$this->add_render_attribute( 'wrapper', 'class', 'aheto__cf--line--pointe-classic' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
  wp_enqueue_style('pointe-contact-forms-layout3', $sc_dir . 'assets/css/pointe_layout3.css', null, null);
}
