...
$this->add_render_attribute( 'wrapper', 'class', ' widget_aheto__cf--funero-big-form' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('funero-contact-form-layout2', $shortcode_dir . 'assets/css/funero_layout2.css', null, null);
}
?>
