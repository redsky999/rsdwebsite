...
$this->add_render_attribute( 'wrapper', 'class', ' widget_aheto__cf--soapy-classic-form' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('soapy-contact-forms-layout1', $shortcode_dir . 'assets/css/soapy_layout1.css', null, null);
}
if ( !Helper::is_Elementor_Live()) {
	wp_enqueue_script('soapy-contact-forms-layout1-js', $shortcode_dir . 'assets/js/soapy_layout1.min.js', array('jquery'), null);
} ?>
