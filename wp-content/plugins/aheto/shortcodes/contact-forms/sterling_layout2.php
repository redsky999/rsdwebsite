...
$this->add_render_attribute('wrapper', 'class', 'aheto__cf-sterling-2');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-contact-forms-layout2', $sc_dir . 'assets/css/sterling_layout2.css', null, null);
}
?>
