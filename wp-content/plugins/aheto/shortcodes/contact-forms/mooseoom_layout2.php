...
$this->add_render_attribute('wrapper', 'class', 'widget_aheto__cf--mooseoom__modern');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('mooseoom-contact-forms-layout2', $shortcode_dir . 'assets/css/mooseoom_layout2.css', null, null);
} ?>
