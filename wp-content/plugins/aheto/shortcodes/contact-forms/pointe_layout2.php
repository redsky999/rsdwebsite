...
$this->add_render_attribute( 'wrapper', 'class', 'aheto__cf--line--pointe-newsletter' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
  wp_enqueue_style('pointe-contact-forms-layout2', $sc_dir . 'assets/css/pointe_layout2.css', null, null);
}
