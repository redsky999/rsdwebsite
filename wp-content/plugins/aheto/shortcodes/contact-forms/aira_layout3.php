...
$this->add_render_attribute( 'wrapper', 'class', 'widget widget_aheto__cf--aira-creative-form' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-cf-creative-form', $sc_dir . 'assets/css/aira_layout3.css', null, null);
}
?>
