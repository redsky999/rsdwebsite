...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-coming-soon--pointe' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-coming-soon-layout1', $shortcode_dir  . 'assets/css/pointe_layout1.css', null, null);
}
