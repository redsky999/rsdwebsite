...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-coming-soon--noize' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style( 'noize-coming-soon-layout1', $shortcode_dir . 'assets/css/noize_layout1.css', null, null );
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
    <div class="aheto-coming-soon__unit">
        <div class="aheto-coming-soon__number js-aheto-soon-number days"><?php echo esc_html($days);?></div>
