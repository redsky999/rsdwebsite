...
$this->add_render_attribute('wrapper', 'class', 'aheto-coming-soon--hr-default');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('hryzantema-coming-soon-layout1', $shortcode_dir . 'assets/css/hryzantema_layout1.css', null, null);
} ?>
