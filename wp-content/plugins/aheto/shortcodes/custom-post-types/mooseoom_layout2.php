...
$this->add_render_attribute('wrapper', 'class', 'aheto-cpt--masonry-mooseoom');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('mooseoom-custom-post-types-layout2', $shortcode_dir . 'assets/css/mooseoom_layout2.css', null, null);
}
