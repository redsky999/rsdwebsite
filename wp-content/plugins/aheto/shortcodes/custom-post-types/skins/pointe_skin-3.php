...
$classes   = [];
$classes[] = 'aheto-cpt-article aheto-cpt-article__pointe-1';
...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-skin-3', $sc_dir . 'assets/css/pointe_skin-3.css', null, null);
}
?>
