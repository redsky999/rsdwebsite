...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_style('famulus-skin-3', $shortcode_dir . 'assets/css/famulus_skin-3.css', null, null);
}
	...
	<div class="aheto-cpt-article__inner">
		...
		<div class="aheto-cpt-article__content">
			...
			<h6 class="aheto-cpt-article__date">
				<?php the_time(get_option('date_format')); ?> <span><?php esc_html_e('in World', 'famulus'); ?></span>
			</h6>
			<?php
			$this->getTitle();
			?>
