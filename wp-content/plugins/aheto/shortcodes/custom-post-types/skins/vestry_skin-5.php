...
$classes   = [];
$classes[] = 'aheto-cpt-article aheto-cpt-article__vestry-5';
...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_style('vestry-skin-5', $shortcode_dir . 'assets/css/vestry_skin-5.css', null, null);
}
?>
	...
	<div class="aheto-cpt-article__inner">
		...
		<div class="aheto-cpt-article__content">
			...
			<div class="aheto-cpt-article__infos">
				<?php if (!empty($vestry_start_time) || !empty($vestry_end_time)) { ?>
					<div class="aheto-cpt-article__date-dur">
				...
				<?php if (!empty($vestry_address) || !empty($vestry_city) || !empty($vestry_country)) { ?> <div class="aheto-cpt-article__address">
		...
		<?php if (!empty($atts['vestry_link_text'])) { ?>
			<div class="aheto-cpt-article__link">
				<a href="<?php the_permalink(); ?>" class="aheto-btn aheto-btn--dark aheto-btn--reverse">
