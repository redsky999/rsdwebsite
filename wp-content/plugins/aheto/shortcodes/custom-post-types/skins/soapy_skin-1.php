...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_style('soapy-skin-1', $shortcode_dir . 'assets/css/soapy_skin-1.css', null, null);
}
...
<article class="<?php echo esc_attr(implode(' ', $classes)); ?>">
	<div class="aheto-cpt-article__inner">
		...
		<h4 class="aheto-cpt-article__date">
			<?php echo get_the_date('F jS Y') ?> / <?php echo esc_html(implode(', ', $soapy_terms)); ?>
		</h4>
		<div class="aheto-cpt-article__content">
			...
			<div class="aheto-cpt-article__links">
				<a href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e('Read More', 'soapy'); ?></a>
			</div>
		</div>
	</div>
</article>
