...
$classes   = [];
$classes[] = 'aheto-cpt-article aheto-cpt-article__sterling-1';
...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-skin-1', $sc_dir . 'assets/css/sterling_skin-1.css', null, null);
}
?>
