...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-cpt--acacio-modern' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('acacio-custom-post-types-layout1', $shortcode_dir . 'assets/css/acacio_layout1.css', null, null);
}
 ?>
