...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-socials-networks-pointe' );
...
if ( isset( $scheme ) && 'inverse' === $scheme ) {
	$this->add_render_attribute( 'link', 'class', 'aheto-socials__link-inverse' );
}
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style( 'pointe-social-networks-layout1', $sc_dir . 'assets/css/pointe_layout1.css', null, null );
}
?>
