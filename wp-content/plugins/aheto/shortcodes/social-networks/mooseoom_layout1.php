...
$this->add_render_attribute('wrapper', 'class', 'aheto-socials--mooseoom-networks');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('mooseoom-social-networks-layout1', $shortcode_dir . 'assets/css/mooseoom_layout1.css', null, null);
}
