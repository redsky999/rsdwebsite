...
$djo_light_version = isset($djo_light_version) && $djo_light_version ? 'dark-version' : '';

// Wrapper.
$this->add_render_attribute( 'wrapper', 'id', $element_id );
$this->add_render_attribute( 'wrapper', 'class', 'aheto-socials--networks-djo-modern' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('djo-social-networks-layout1', $shortcode_dir . 'assets/css/djo_layout1.css', null, null);
}
?>
