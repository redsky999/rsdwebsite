...
$this->add_render_attribute('wrapper', 'class', 'aheto-socials-networks--karma_dark_portfolio');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('karma-dark-portfolio-social-networks-layout1', $sc_dir . 'assets/css/karma_dark_portfolio_layout1.css', null, null);
}
?>
