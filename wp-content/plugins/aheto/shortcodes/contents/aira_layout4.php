...
$aira_box_shadow = $aira_box_shadow ? 'aheto-contents__box_shadow' : '';
...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--aira-faq');
$this->add_render_attribute('wrapper', 'class', 'js-accordion-parent');
$this->add_render_attribute('wrapper', 'class', $aira_box_shadow );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-contents-faq', $sc_dir . 'assets/css/aira_layout4.css', null, null);
}
?>
