...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--faq-pointe-classic');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-contents-layout1', $sc_dir . 'assets/css/pointe_layout1.css', null, null);
}
?>
<div <?php $this->render_attribute_string('wrapper'); ?>>
	...
	foreach ( $faqs as $key => $item ) :
		...
		<div class="aheto-contents__item <?php echo esc_attr($class_active); ?>">
			...
			<?php if ( $item['title'] ) : ?>
				<h4 class="aheto-contents__title js-accordion"><?php echo wp_kses($item['title'], 'post'); ?></h4>
			<?php endif; ?>
