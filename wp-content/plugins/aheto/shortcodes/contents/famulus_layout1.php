...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--faq-famulus-simple');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('famulus-contents-layout1', $shortcode_dir . 'assets/css/famulus_layout1.css', null, null);
}
