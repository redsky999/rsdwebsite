...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--vestry-faq');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style( 'vestry-contents-layout1', $shortcode_dir . 'assets/css/vestry_layout1.css', null, null );
}
