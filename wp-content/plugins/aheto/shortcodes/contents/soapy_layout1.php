...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--faq-soapy-simple');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('soapy-contents-layout1', $shortcode_dir . 'assets/css/soapy_layout1.css', null, null);
}
?>
