...
use Aheto\Helper;
add_action( 'aheto_before_aheto_pricing-tables_register', 'pointe_pricing_tables_layout1' );
...
function pointe_pricing_tables_layout1( $shortcode ) {
	...
	aheto_demos_add_dependency(['price', 'features'], ['pointe_layout1'], $shortcode);
	
	$shortcode->add_dependecy('pointe_heading', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_active', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_background', 'template', 'pointe_layout1');
    ...
    $shortcode->add_dependecy('pointe_use_item_typo', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_item_typo', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_item_typo', 'pointe_use_item_typo', 'true');

    $shortcode->add_dependecy('pointe_use_value_typo', 'template', ['pointe_layout1']);
    $shortcode->add_dependecy('pointe_value_typo', 'template', ['pointe_layout1']);
	...
	$shortcode->add_params( [
		...
		'pointe_use_value_typo' => [
            'type'    => 'switch',
            'heading' => esc_html__('Use custom font for Prise?', 'pointe'),
        ],
        'pointe_value_typo' => [
            'type'     => 'typography',
...
function pointe_pricing_tables_layout1_dynamic_css( $css, $shortcode ) {
...
add_filter('aheto_pricing_tables_dynamic_css', 'pointe_pricing_tables_layout1_dynamic_css', 10, 2);
