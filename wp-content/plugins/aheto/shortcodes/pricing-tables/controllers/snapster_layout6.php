...
add_action( 'aheto_before_aheto_pricing-tables_register', 'snapster_pricing_tables_layout6' );
...
function snapster_pricing_tables_layout6( $shortcode ) {

	$preview_dir = '//assets.aheto.co/pricing-tables/previews/';

	$shortcode->add_layout( 'snapster_layout6', [
		'title' => esc_html__( 'Snapster With Media', 'snapster' ),
		'image' => $preview_dir . 'snapster_layout6.jpg',
	] );

	$shortcode->add_dependecy( 'snapster_with_media', 'template', 'snapster_layout6' );

	$shortcode->add_dependecy( 'snapster_use_title_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_title_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_title_typo', 'snapster_use_title_typo', 'true' );

	$shortcode->add_dependecy( 'snapster_use_subtitle_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_subtitle_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_subtitle_typo', 'snapster_use_subtitle_typo', 'true' );

	$shortcode->add_dependecy( 'snapster_use_price_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_price_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_price_typo', 'snapster_use_price_typo', 'true' );

	$shortcode->add_dependecy( 'snapster_use_currency_typo', 'template', 'snapster_layout6' );
	$shortcode->add_dependecy( 'snapster_currency_typo', 'template', 'snapster_layout6' );
	...
	\Aheto\Params::add_image_sizer_params( $shortcode, [
		...
		'prefix'     => 'snapster_with_media_',
		'dependency' => [ 'template', [ 'snapster_layout6' ] ]
	] );
	...
	\Aheto\Params::add_video_button_params($shortcode, [
		'add_label' => esc_html__('Add video?', 'snapster'),
		'prefix' => 'snapster_with_media_',
	], 'snapster_with_media');
}

function snapster_pricing_tables_layout6_dynamic_css( $css, $shortcode ) {
...
add_filter( 'aheto_pricing_tables_dynamic_css', 'snapster_pricing_tables_layout6_dynamic_css', 10, 2 );
