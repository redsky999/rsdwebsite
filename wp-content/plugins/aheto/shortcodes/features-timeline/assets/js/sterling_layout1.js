;(function ($, window, document, undefined) {
  ...
  let timelines = $('.aheto-timeline--sterling-modern'),
  ...
  */
  ...
  function checkMQ() {
      ...
      return window.getComputedStyle(document.querySelector('.aheto-timeline--sterling-modern'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
  }
