...
$this->add_render_attribute('inner', 'class', 'sterling-list-2 sterling-list--number');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('sterling-list-2', $sc_dir . 'assets/css/sterling_layout2.css', null, null);
}
?>
