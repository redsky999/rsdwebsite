...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-list--mooseoom-table-links' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style( 'mooseoom-list-layout3', $shortcode_dir . 'assets/css/mooseoom_layout3.css', null, null );
}
?>
