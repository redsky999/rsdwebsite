(function ($) {
	...
	$(window).on('load', function(){
		if($('.aheto-banner-slider--azyn-animated').length){
			!function (n, e) {
				...
				function s(n, e) {
					var t = c(n), o = a(i.und(t[0]) ? 1 : t[0], .1, 100), u = a(i.und(t[1]) ? 100 : t[1], .1, 100),
						s = a(i.und(t[2]) ? 10 : t[2], .1, 100), f = a(i.und(t[3]) ? 0 : t[3], .1, 100),
						l = Math.sqrt(u / o), d = s / (2 * Math.sqrt(u * o)), p = d < 1 ? l * Math.sqrt(1 - d * d) : 0,
						v = 1, h = d < 1 ? (d * l - f) / p : -f + l;
				...
				function O(n) {
					return i.rgb(n) ? (t = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e = n)) ? "rgba(" + t[1] + ",1)" : e : i.hex(n) ? (r = n.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (n, e, t, r) {
						...
						var e, t, r,
							...
							o = parseInt(a[1], 10) / 360, u = parseInt(a[2], 10) / 100, i = parseInt(a[3], 10) / 100,
							c = a[4] || 1;
				...
				function z(n, e) {
					X(n).forEach(function (n) {
						for (var t in e) {
							var r = P(e[t], n), a = n.target, o = C(r), u = A(a, t, o, n), i = N(S(r, o || C(u)), u),
								c = T(a, t);
			...
			new Slideshow(document.querySelector('.aheto-banner-slider--azyn-animated'));
		}
	});
