...
// ----- Q SLIDE ----- //
		function qSlide(q_slide) {
			...
			function q_slideSwitch(q_slide, index, auto) {
				...
				if (q_slide.getAttribute('data-animate') != null) {
					var animation = q_slide.getAttribute('data-animate') || 'stagTop';
			...
			if (q_slide.getAttribute('data-mousefollow') != null) {
