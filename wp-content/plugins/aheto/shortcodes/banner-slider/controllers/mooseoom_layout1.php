...
add_action('aheto_before_aheto_banner-slider_register', 'mooseoom_banner_slider_layout1');

/**
 *  Banner Slider
 */

function mooseoom_banner_slider_layout1($shortcode)
{

	$preview_dir = '//assets.aheto.co/banner-slider/previews/';

	$shortcode->add_layout('mooseoom_layout1', [
		'title' => esc_html__('Banner Slider 14', 'aheto'),
		'image' => $preview_dir . 'mooseoom_layout1.jpg',
	]);

	aheto_demos_add_dependency( ['use_heading', 't_heading'], [ 'mooseoom_layout1' ], $shortcode );

	$shortcode->add_dependecy('mooseoom_banner_theme', 'template', 'mooseoom_layout1');
	
	$shortcode->add_dependecy('mooseoom_modern_banners', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_banner_theme', 'template', 'mooseoom_layout1');
	...
	$shortcode->add_dependecy('mooseoom_use_desc_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_desc_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_desc_typo', 'mooseoom_use_desc_typo', 'true');

	$shortcode->add_dependecy('mooseoom_use_arrows_text_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_arrows_text_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_arrows_text_typo', 'mooseoom_use_arrows_text_typo', 'true');

	$shortcode->add_dependecy('mooseoom_use_fontarrov_text_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_fontarrov_text_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_fontarrov_text_typo', 'mooseoom_use_fontarrov_text_typo', 'true');
	
	$shortcode->add_dependecy('mooseoom_use_fontarrov_typo', 'template', 'mooseoom_layout1');
	$shortcode->add_dependecy('mooseoom_fontarrov_typo', 'template', 'mooseoom_layout1');
	...
	$shortcode->add_params([
		...
		'mooseoom_use_fontarrov_typo' => [
			...
			'heading' => esc_html__( 'Use custom font for arrow?', 'aheto' ),
			'grid'    => 3,
		],
...
function mooseoom_banner_slider_layout1_dynamic_css( $css, $shortcode ) {
...
add_filter('aheto_banner_slider_dynamic_css', 'mooseoom_banner_slider_layout1_dynamic_css', 10, 2);