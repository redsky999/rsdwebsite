...
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_script('banner-slider-style-1-js', $shortcode_dir . 'assets/js/layout1.min.js', array('jquery'), null);
}
?>
            ...
            <div class="swiper-wrapper">
				...
				<?php foreach ( $banners as $banner ) :
                    ...
                    <div class="swiper-slide">
                        <div class="banner-slide full-min-height-js <?php echo esc_attr( $align . ' ' . $lazy_class ); ?>" <?php echo esc_attr( $background_image ); ?>>
