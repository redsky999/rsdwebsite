...
$this -> add_render_attribute ( 'wrapper', 'class', 'aheto_video-btn--ninedok__modern' );
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style ( 'ninedok-video-btn-layout1', $shortcode_dir . 'assets/css/ninedok_layout1.css', null, null );
} ?>
