...
$acacio_add_border_color = isset($acacio_add_border_color) && $acacio_add_border_color ? 'custom-border' : '';
// Wrapper.
$this->add_render_attribute('wrapper', 'id', $element_id);
$this->add_render_attribute('wrapper', 'class', $this->the_custom_classes());
$this->add_render_attribute('wrapper', 'class', 'aheto-team-member--acacio-simple');
$this->add_render_attribute('wrapper', 'class', $acacio_add_border_color);
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style( 'acacio-team-member-layout1', $shortcode_dir . 'assets/css/acacio_layout1.css', null, null );
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	<?php if ( !empty($image) ) : ?>
		<div class="aheto-team-member__img-holder">
            <?php echo \Aheto\Helper::get_attachment( $image, ['class' => 'aheto-team-member__img'], $acacio_image_size, $atts, 'acacio_' ); ?>
		</div>
	<?php endif; ?>
