...
$this -> add_render_attribute ( 'wrapper', 'class', 'aheto-team-member--ninedok-simple' );
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style ( 'ninedok-team-member-layout1', $shortcode_dir . 'assets/css/ninedok_layout1.css', null, null );
} ?>
<div <?php $this -> render_attribute_string ( 'wrapper' ); ?>>
	<?php if ( !empty( $image )) : ?>
        <div class="aheto-team-member__img-holder">
			<?php echo Helper ::get_attachment ( $image, [ 'class' => 'aheto-team-member__img' ], $ninedok_image_size, $atts, 'ninedok_' ); ?>
        </div>
	<?php endif; ?>
