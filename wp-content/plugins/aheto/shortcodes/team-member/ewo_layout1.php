...
$this->add_render_attribute('wrapper', 'class', 'aheto-team-member--ewo-simple');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('ewo-team-member-layout1', $shortcode_dir . 'assets/css/ewo_layout1.css', null, null);
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	<?php if (!empty($image)) : ?>
		<div class="aheto-team-member__img-holder">
			<?php echo Helper::get_attachment($image, ['class' => 'aheto-team-member__img'], $ewo_image_size, $atts, 'ewo_'); ?>
		</div>
	<?php endif; ?>
	<div class="aheto-team-member__text">
		...
		// Name.
		if (!empty($name)) {
			echo '<h5 class="aheto-team-member__name">' . esc_html($name) . '</h5>';
		}
		// Designation.
