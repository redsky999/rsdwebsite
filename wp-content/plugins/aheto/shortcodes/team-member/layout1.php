    ...
    <div class="aheto-team-member__text">
		...
		if ( $networks ) { ?>
            <div class="aheto-team-member__contact">
				<?php echo Helper::get_social_networks( $networks, '<a class="aheto-team-member__link" target="_blank" href="%1$s" rel="noreferrer noopener"><i class="ion-social-%2$s"></i></a>' ); ?>
            </div>
		<?php } ?>
    </div>
</div>
