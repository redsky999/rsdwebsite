...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-twitter--pointe' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-twitter-layout1', $sc_dir . 'assets/css/pointe_layout1.css', null, null);
}
