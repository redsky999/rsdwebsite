...
$this->add_render_attribute('wrapper', 'class', 'main-header--pointe-first');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('pointe-navigation-layout1', $sc_dir . 'assets/css/pointe_layout1.css', null, null);
}
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_script('pointe-navigation-layout1-js', $sc_dir . 'assets/js/pointe_layout1.min.js', array('jquery'), null);
}
            ...
            <div class="main-header__widget-box-mobile">
                ...
                <?php if ($search) : ?>
                    <div class="mobile-menu__search-wrap">
                        <!-- SEARCH -->
                        <form role="search" class="w-800" method="get" id="searchform_mobile" action="<?php echo esc_url(home_url('/')); ?>">
