...
$this->add_render_attribute('wrapper', 'class', 'main-header--bizy-second');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('bizy-navigation-layout3', $shortcode_dir . 'assets/css/bizy_layout3.css', null, null);
}
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_script('bizy-navigation-js-layout3', $shortcode_dir . 'assets/js/bizy_layout3.min.js', array('jquery'), null);
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
    <div class="main-header__main-line">
        ...
        <div class="main-header__menu-box">
            ...
            <?php if (!empty($bizy_mob_menu_title)) { ?>
                <div class="main-header__mob_menu_title">
                    <?php echo wp_kses($bizy_mob_menu_title, 'post'); ?>
                </div>
            <?php } ?>
            ...
            <div class="main-header__widget-box-mobile">
                ...
                <?php if ($bizy_main_mob_add_button) { ?>
                    <?php echo Helper::get_button($this, $atts, 'bizy_main_mob_'); ?>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="main-header__widget-box">
            ...
            <div class="main-header__widget-box-desktop">
                ...
                <?php
                if ($bizy_main_add_button) { ?>
                    <div class="aheto-btn--nonscrolled">
                        <?php echo Helper::get_button($this, $atts, 'bizy_main_'); ?>
                    </div>
                <?php }

                if ($bizy_scroll_main_add_button) { ?>
                    <div class="aheto-btn--scrolled">
                        <?php echo Helper::get_button($this, $atts, 'bizy_scroll_main_'); ?>
                    </div>
                <?php } ?>
