...
$this->add_render_attribute( 'wrapper', 'class', 'main-header--classic' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style( 'navigation-style-5', $sc_dir . 'assets/css/layout5.css', null, null );
}
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_script('navigation-layout5-js', $sc_dir . 'assets/js/layout5.min.js', array('jquery'), null);
}

$link_logo = isset($change_link_logo) && $change_link_logo && !empty($link_logo) ? $link_logo : home_url( '/' );
    ...
    <div class="main-header__main-line">
        ...
        <div class="main-header__menu-box">
            ...
            <div class="main-header__widget-box-mobile">
				...
				if ( $add_mob_add_button ) { ?>
					<?php echo Helper::get_button( $this, $atts, 'add_mob_' ); ?>
				<?php } ?>
            </div>
        ...
        <div class="main-header__widget-box">
            ...
            <div class="main-header__widget-box-desktop">
				...
				if ( $add_add_button ) { ?>
					<?php echo Helper::get_button( $this, $atts, 'add_' ); ?>
				<?php } ?>
            </div>
