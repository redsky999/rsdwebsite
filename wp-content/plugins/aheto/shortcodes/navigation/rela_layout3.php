...
// Nav.
$this->add_render_attribute('nav', 'class', 'widget-nav-menu widget-nav-menu--rela-footer');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('rela-navigation-layout3', $shortcode_dir . 'assets/css/rela_layout3.css', null, null);
}
