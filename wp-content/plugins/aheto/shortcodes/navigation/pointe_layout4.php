...
$this->add_render_attribute('wrapper', 'class', 'main-header--pointe-classes');
...
if ((empty($custom_css) || ($custom_css == "disabled")) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-navigation-classes', $sc_dir . 'assets/css/pointe_layout4.css', null, null);
}
if (!Helper::is_Elementor_Live()) {
	wp_enqueue_script('pointe-navigation-classes-js', $sc_dir . 'assets/js/pointe_layout4.min.js', array('jquery'), null);
}
