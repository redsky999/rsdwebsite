...
add_action('aheto_before_aheto_navigation_register', 'pointe_navigation_layout4');

/**
 *  Banner Slider
 */

function pointe_navigation_layout4($shortcode)
{

	$preview_dir = '//assets.aheto.co/navigation/previews/';

	$shortcode->add_layout('pointe_layout4', [
		'title' => esc_html__('Pointe header 4', 'pointe'),
		'image' => $preview_dir . 'pointe_layout4.jpg',
	]);

	aheto_demos_add_dependency(['max_width', 'add_scroll_logo', 'scroll_logo', 'mob_logo','scroll_mob_logo', 'add_mob_scroll_logo', 'transparent', 'logo', 'label_logo', 'type_logo', 'text_logo', 'search'], ['pointe_layout4'], $shortcode);

	$shortcode->add_dependecy('pointe_use_desk_menu_link_typo', 'template', 'pointe_layout4');
	$shortcode->add_dependecy('pointe_desk_menu_link_typo', 'pointe_use_desk_menu_link_typo', 'true');
	
	$shortcode->add_dependecy('pointe_mob_menu_title', 'template', 'pointe_layout4');
	$shortcode->add_dependecy('pointe_desk_menu_title', 'template', 'pointe_layout4');
	$shortcode->add_dependecy('pointe_desk_menu', 'template', 'pointe_layout4');
	$shortcode->add_dependecy('pointe_use_mob_menu_title_typo', 'template', 'pointe_layout4');
    $shortcode->add_dependecy('pointe_mob_menu_title_typo', 'pointe_use_mob_menu_title_typo', 'true');
	$shortcode->add_dependecy('pointe_use_desk_menu_title_typo', 'template', 'pointe_layout4');
    $shortcode->add_dependecy('pointe_desk_menu_title_typo', 'pointe_use_desk_menu_title_typo', 'true');
	$shortcode->add_dependecy('pointe_use_label_logo_typo', 'template', 'pointe_layout4');
    $shortcode->add_dependecy('pointe_label_logo_typo', 'pointe_use_label_logo_typo', 'true');
    $shortcode->add_dependecy('pointe_use_icon_typo', 'template', 'pointe_layout4');
    $shortcode->add_dependecy('pointe_icon_typo', 'pointe_use_icon_typo', 'true');
    $shortcode->add_dependecy('pointe_use_link_typo', 'template', 'pointe_layout4');
    $shortcode->add_dependecy('pointe_link_typo', 'pointe_use_link_typo', 'true');
    $shortcode->add_dependecy('pointe_use_sub_link_typo', 'template', 'pointe_layout4');
    ...
    \Aheto\Params::add_button_params($shortcode, [
        ...
        'icons'      => true,
        'dependency' => ['template', ['pointe_layout4']]
    ]);
    \Aheto\Params::add_button_params($shortcode, [
...
function pointe_navigation_layout4_dynamic_css($css, $shortcode)
{
...
add_filter('aheto_navigation_dynamic_css', 'pointe_navigation_layout4_dynamic_css', 10, 2);
