...
function rela_navigation_layout4($shortcode)
{
    ...
    $shortcode->add_layout('rela_layout4', [
        'title' => esc_html__('Navigation 26', 'rela'),
        'image' => $shortcode_dir . 'hryzantema_layout1.jpg',
    ]);
    ...
    aheto_demos_add_dependency(['search', 'max_width', 'mob_logo', 'label_logo', 'type_logo', 'logo', 'text_logo', 'mobile_menu_width'], ['rela_layout4'], $shortcode);
