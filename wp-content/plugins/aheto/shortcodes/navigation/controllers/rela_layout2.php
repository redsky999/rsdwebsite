...
add_action('aheto_before_aheto_navigation_register', 'rela_navigation_layout2');


/**
 * Navigation Shortcode
 */
function rela_navigation_layout2($shortcode)
{
    ...
    $shortcode->add_layout('rela_layout2', [
        'title' => esc_html__('Navigation 24', 'rela'),
        'image' => $shortcode_dir . 'rela_layout2.jpg',
    ]);


    $shortcode->add_dependecy('rela_mob_menu_title', 'template', 'rela_layout2');
    $shortcode->add_dependecy('rela_dropdown_ico_size', 'template', 'rela_layout2');

    $shortcode->add_dependecy('rela_use_mob_menu_title_typo', 'template', 'rela_layout2');
    $shortcode->add_dependecy('rela_mob_menu_title_typo', 'template', 'rela_layout2');
    $shortcode->add_dependecy('rela_mob_menu_title_typo', 'rela_use_mob_menu_title_typo', 'true');

    $shortcode->add_dependecy( 'rela_use_submenu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_submenu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_submenu_typo', 'rela_use_submenu_typo', 'true' );

    $shortcode->add_dependecy( 'rela_use_menu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_menu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_menu_typo', 'rela_use_menu_typo', 'true' );

    $shortcode->add_dependecy( 'rela_use_megamenu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_megamenu_typo', 'template', 'rela_layout2' );
    $shortcode->add_dependecy( 'rela_megamenu_typo', 'rela_use_megamenu_typo', 'true' );

    $shortcode->add_dependecy('rela_search_size', 'template', 'rela_layout2');

    aheto_demos_add_dependency(['max_width', 'mob_logo','add_scroll_logo', 'scroll_logo', 'add_mob_scroll_logo', 'scroll_mob_logo', 'transparent', 'type_logo', 'logo', 'text_logo', 'mobile_menu_width' ], ['rela_layout2'], $shortcode);
...
function rela_navigation_layout2_dynamic_css($css, $shortcode)
{
...
add_filter('aheto_navigation_dynamic_css', 'rela_navigation_layout2_dynamic_css', 10, 2);