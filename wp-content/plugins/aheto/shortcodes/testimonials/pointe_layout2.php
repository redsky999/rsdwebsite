...
$this->add_render_attribute('wrapper', 'class', 'aheto-tm-wrapper--pointe-expert');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('pointe-testimonials-layout2', $sc_dir . 'assets/css/pointe_layout2.css', null, null);
}
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	...
	<div class="swiper">
		<div class="swiper-container" <?php echo esc_attr($carousel_params); ?>>
							...
							<div class="aheto-tm__author">
								<div class="aheto-tm__info">
									...
									if ( !empty($item['pointe_name']) ) {
										echo '<h2 class="aheto-tm__name">' . wp_kses_post($item['pointe_name'], 'post') . '</h2>';
									}
			...
			<div class='pointe_swiper_arrows'>
