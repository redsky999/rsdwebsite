...
$this->add_render_attribute('wrapper', 'class', 'aheto-tm-wrapper--aira-classic');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style('aira-testimonials-classic', $sc_dir . 'assets/css/aira_layout2.css', null, null);
}
?>
                            ...
                            <div class="aheto-tm__author">
                                ...
                                <div class="aheto-tm__info">
                                    ...
                                    if (isset($item['aira_company'])) {
                                        echo '<h6 class="aheto-tm__position">' . wp_kses($item['aira_company'], 'post') . '</h6>';
                                    }
                                    ?>
                                </div>
                            </div>
