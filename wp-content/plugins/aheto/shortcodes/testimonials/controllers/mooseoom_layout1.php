...
use Aheto\Helper;
add_action( 'aheto_before_aheto_testimonials_register', 'mooseoom_testimonials_layout1' );

/**
 * Testimonials
 */

function mooseoom_testimonials_layout1( $shortcode ) {

	$preview_dir = '//assets.aheto.co/testimonials/previews/';

	$shortcode->add_layout( 'mooseoom_layout1', [
		'title' => esc_html__( 'Testimonials 15', 'mooseoom' ),
		'image' => $preview_dir . 'mooseoom_layout1.jpg',
	] );

	$shortcode->add_dependecy('mooseoom_testimonials', 'template', ['mooseoom_layout1']);
	...
	$shortcode->add_dependecy('mooseoom_use_name_typo', 'template', ['mooseoom_layout1']);
	$shortcode->add_dependecy('mooseoom_name_typo', 'template', 'mooseoom_layout1');
...
function mooseoom_testimonials_layout1_dynamic_css($css, $shortcode)
{
...
add_filter('aheto_team_member_dynamic_css', 'mooseoom_testimonials_layout1_dynamic_css', 10, 2);