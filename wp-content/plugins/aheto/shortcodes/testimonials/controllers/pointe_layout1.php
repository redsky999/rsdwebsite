...
use Aheto\Helper;
add_action( 'aheto_before_aheto_testimonials_register', 'pointe_testimonials_layout1' );

/**
 * Testimonials
 */

function pointe_testimonials_layout1( $shortcode ) {
	...
	$shortcode->add_dependecy('pointe_testimonials_minimal', 'template', 'pointe_layout1');
    ...
    $shortcode->add_dependecy('use_pointe_name_typo', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_name_typo', 'template', 'pointe_layout1');
    $shortcode->add_dependecy('pointe_name_typo', 'use_pointe_name_typo', 'true');

    $shortcode->add_dependecy('use_pointe_position_typo', 'template', 'pointe_layout1');
...
add_filter('aheto_team_member_dynamic_css', 'pointe_testimonials_layout1_dynamic_css', 10, 2);