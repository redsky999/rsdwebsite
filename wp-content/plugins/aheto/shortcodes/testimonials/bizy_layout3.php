...
$this->add_render_attribute( 'wrapper', 'class', 'aheto-tm-wrapper--bizy-yellow' );
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
    wp_enqueue_style( 'bizy-testimonials-layout3', $shortcode_dir . 'assets/css/bizy_layout3.css', null, null );
}
