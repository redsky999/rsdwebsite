	...
	<div class="cost-calculator-form-container">
		<div class="cost-calculator-form-container-row cost-calculator-clearfix">
			...
			<div class="cost-calculator-column-right">
				...
				<img id="shortcode-delete" src="<?php echo WP_PLUGIN_URL; ?>/ql-cost-calculator/admin/images/delete.png" alt="del" title="<?php _e("Delete this shortcode", "cost-calculator"); ?>">
			</div>
		</div>
		<div class="cost-calculator-form-container-row cost-calculator-clearfix">
			<div class="cost-calculator-column-left">
		...
		<div class="cost-calculator-hidden">
			...
			<div class="cost-calculator-advanced-settings-container cost-calculator-clearfix">
				...
				<div class="cost-calculator-advanced-settings-column cost-calculator-advanced-settings-left">
					...
					<div class="cost-calculator-form-container-row cost-calculator-clearfix">
						<div class="cost-calculator-column-left">
							<label for="primary_font"><?php _e("Primary font google", "cost-calculator"); ?></label>
						</div>
						<div class="cost-calculator-column-right">
							<span class="spinner"></span>
							<select id="primary_font" name="primary_font" class="cost-calculator-fonts-dropdown">
								...
								?>
									...
									if($variantsCount>1)
									{
										...
										{
										?>
											<option value="<?php echo esc_attr($fontsArray->items[$i]->family . ":" . $fontsArray->items[$i]->variants[$j]); ?>"><?php echo $fontsArray->items[$i]->family . ":" . $fontsArray->items[$i]->variants[$j]; ?></option>
										<?php
										}
									}
									else
				...
				<div class="cost-calculator-advanced-settings-column cost-calculator-advanced-settings-right">
					...
					<div class="cost-calculator-form-container-row cost-calculator-clearfix">
						<div class="cost-calculator-column-left">
							<label for="secondary_font"><?php _e("Secondary font google", "cost-calculator"); ?></label>
						</div>
						<div class="cost-calculator-column-right">
							<span class="spinner"></span>
							<select id="secondary_font" name="secondary_font" class="cost-calculator-fonts-dropdown">
