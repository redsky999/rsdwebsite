...
$this->add_render_attribute( 'wrapper', 'class', 'widget widget_aheto__cf--outsourceo__subscribe-simple' );
...
wp_enqueue_style('outsourceo-subscribe-simple', $sc_dir . 'assets/css/cs_layout1.css', null, null); ?>
