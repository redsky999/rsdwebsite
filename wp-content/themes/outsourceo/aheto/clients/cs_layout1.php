 ...
 * Set dependent style
 */
$sc_dir = OUTSOURCEO_T_URI . '/aheto/clients/';
wp_enqueue_style('outsourceo-clients-modern', $sc_dir . 'assets/css/cs_layout1.css', null, null);
...
<div <?php $this->render_attribute_string('wrapper'); ?>>
	...
	<div class="aheto-clients__aside-text">
		<?php if ( isset($cs_aside_text) && !empty($cs_aside_text) ) : ?>
			<p><?php echo esc_html($cs_aside_text); ?></p>
		<?php endif; ?>
	</div>
