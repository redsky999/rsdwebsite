...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--outsourceo-faq');
...
wp_enqueue_style( 'outsourceo-contents-faq', $sc_dir . 'assets/css/cs_layout3.css', null, null );
?>
	...
	foreach ( $faqs as $key => $item ) :
		...
		<div class="aheto-contents__item <?php echo esc_attr($class_active); ?>">
			<?php if ( !empty($item['title']) ) : ?>
				<h5 class="aheto-contents__title js-accordion"><?php echo wp_kses($item['title'], 'post'); ?><i class="ion-android-arrow-dropright"></i></h5>
			<?php endif; ?>
